...
public class InvestorService {
	...
	//public static List<Patron> patronsStore = new ArrayList<>();
	...
	static {
		...
		String[] normalUserRoles = { "users"};
		String[] adminUserRoles = {"admin", "users"};
//		patronsStore.add(new Patron("user_1", "invr_1", "upwd1", normalUserRoles));
//		patronsStore.add(new Patron("user_2", "invr_2", "upwd2", normalUserRoles));
//		patronsStore.add(new Patron("adm_1", "admins", "apwd1", adminUserRoles));
	}
